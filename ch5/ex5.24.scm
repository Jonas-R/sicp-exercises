...
(define (clause-test exp) (car exp))
(define (clause-consequent exp) (cdr exp))
(define (cond-clauses exp) (cdr exp))
(define (cond? exp) (tagged-list? exp 'cond))
(define (else-clause? exp) (tagged-list? exp 'else))

(set! eceval-operations 
      (append eceval-operations
	      (list (list 'first-clause first-clause)
		    (list 'rest-clauses rest-clauses)
		    (list 'cond-clauses cond-clauses)
		    (list 'clause-test clause-test)
		    (list 'clause-consequent clause-consequent)
		    (list 'cond? cond?)
		    (list 'else-clause? else-clause?)
		    (list '= =))))
...
ev-cond-loop
  ...
  (save exp)
  (save continue)
  (assign exp (op clause-test) (reg exp))
...
ev-cond-consequent
  (assign unev (op clause-consequent) (reg exp))
  (save continue)
  (goto (label ev-sequence))
